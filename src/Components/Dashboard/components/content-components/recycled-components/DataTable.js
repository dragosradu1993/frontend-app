...
export default function DataTable(props) {
    ...
    return (
        data.show ? (<DataGrid
            ...
            rows={data.rows}
            columnThreshold = {data.columns.length}
            components={{ Toolbar: GridToolbar, LoadingOverlay: LinearProgress, NoRowsOverlay: NoDataOverlay }}
            localeText={{
                toolbarColumns: 'Coloane',
                toolbarFilters: 'Filtre',
                toolbarDensity: 'Mod afisare',
                toolbarExportPrint: 'Printeaza',
                toolbarExportCSV: 'Exporta in CSV',
            ...
            onSelectionModelChange={(ids) => {
                ...
                if(!(selectedRowData === undefined) || (selectedRowData.length > 0)) {
                    ...
                    setData({...data, selectionModel: selectedRowData})
                }
                props.callback(data.selectionModel)
            }}
            checkboxSelection = {data.isSelectable}
