...
export default function AddTeachers(props) {
    ...
    const StyledGridOverlay = styled('div')(({ theme }) => ({
      ...
      const callbackGridDialog = async (type, dialogData) => {
        ...
        if(type === 'accepted') {
            console.log(dialogData.dataToSend)
          let ok = true
            if(
              ...
              dialogData.dataToSend.hasOwnProperty('department') &&
              dialogData.dataToSend.hasOwnProperty('isCoordinatorBachelors') &&
              dialogData.dataToSend.hasOwnProperty('isCoordinatorDisertation') &&
              dialogData.dataToSend.hasOwnProperty('availableSlotsBachelors') &&
              dialogData.dataToSend.hasOwnProperty('availableSlotsDisertations') 
            ) {
              if(utils.validations.email(dialogData.dataToSend.email)) {
                if(
                  ...
                  !utils.validations.validateStringLength(dialogData.dataToSend.firstName) 
                    ...
                    if(!utils.validations.validateStringLength(dialogData.dataToSend.department)) {
                        if(
                            utils.validations.validateTextFieldNumber(dialogData.dataToSend.availableSlotsBachelors) &&
                            utils.validations.validateTextFieldNumber(dialogData.dataToSend.availableSlotsDisertations)
                        ) {
                            if(
                                dialogData.dataToSend.isCoordinatorBachelors &&
                                parseInt(dialogData.dataToSend.availableSlotsBachelors) === 0
                            ) {
                                console.log('aici')
                                ok = false
                                setGridAlert({isError: true, severity: 'error', textError: stringConstants.error.secretaries.addTeachers.bachelorsTrue})
                            ...
                            if(
                                ...
                                console.log('aici')
                                ok = false
                                setGridAlert({isError: true, severity: 'error', textError: stringConstants.error.secretaries.addTeachers.bachelorsFalse})
                            }
                            if(
                                dialogData.dataToSend.isCoordinatorDisertation &&
                                parseInt(dialogData.dataToSend.availableSlotsDisertations) === 0
                            ) {
                                console.log('aici')
                                ok = false
                                setGridAlert({isError: true, severity: 'error', textError: stringConstants.error.secretaries.addTeachers.disertationTrue})
                            }
                            if(
                                !dialogData.dataToSend.isCoordinatorDisertation &&
                                parseInt(dialogData.dataToSend.availableSlotsDisertations) !== 0
                                ...
                                console.log('aici')
                                ok = false
                                setGridAlert({isError: true, severity: 'error', textError: stringConstants.error.secretaries.addTeachers.disertationFalse})
                            }
                            if(ok) {
                                console.log('aici')
                            ...
                            ok = false
                            setGridAlert({isError: true, severity: 'error', textError: stringConstants.error.secretaries.addTeachers.noNumber})
                        }
                  } else {
                    ok = false
                    setGridAlert({isError: true, severity: 'error', textError: stringConstants.error.secretaries.addTeachers.departmentLength})
                  }
                } else {
                  ok = false
              ...
              ok = false
              setGridAlert({isError: true, severity: 'error', textError: stringConstants.error.secretaries.addTeachers.noData})
            }
    ...
    const handleClick = async (event, index) => {
      ...
      if(button.type === 'register-teachers') {
